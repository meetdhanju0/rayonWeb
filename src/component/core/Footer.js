                ...
                <div className="container py-5 px-lg-5">
                    <div className="row g-5">
                        <div className="col-md-6 col-lg-3">
                            ...
                            <p><i className="fa fa-map-marker me-3" />Head Office: Mohali, India</p>
                            <p><i className="fa fa-map-marker me-3" />Sales Office: Sri Ganganag <span className='sales-ml'>ar, India</span></p>
                            <p><i className="fa fa-map-marker me-3" />Sales Office: Canada</p>
